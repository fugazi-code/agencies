                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-3 mb-2">
                                ...
                                <select class="form-select" wire:model="form.foreign_agency_id">
                            ...
                            <div class="col-md-4 mb-2">
                                ...
                                <input class="form-control" wire:model="form.full_name">
                            ...
                            <div class="col-md-2 mb-2">
                                ...
                                <input type="date" class="form-control" wire:model="form.birth_date">
                            </div>
                            <div class="col-md-3 mb-2">
                                <label>National / IQAMA ID</label>
                                <input class="form-control" wire:model="form.national_id">
                            </div>
                            <div class="col-md-3 mb-2">
                                <label>Passport No.</label>
                                <input class="form-control" wire:model="form.passport">
                            </div>
                            <div class="col-md-3 mb-2">
                                <label>Occupation</label>
                                <input class="form-control" wire:model="form.occupation">
                            </div>
                            <div class="col-12 border-bottom mb-2">
                            ...
                            <div class="col-md-3 mb-2">
                                ...
                                <input class="form-control" wire:model="form.email">
                            </div>
                            <div class="col-md-3 mb-2">
                                <label>Contact Person</label>
                                <input class="form-control" wire:model="form.contact_person">
                            </div>
                            <div class="col-md-12 mb-2">
                                <label>Address Abroad</label>
                                <input type="email" class="form-control" wire:model="form.address_abroad">
                            </div>
                            <div class="col-12 border-bottom mb-2">
                            ...
                            <div class="col-md-12 d-flex flex-row mb-2">
                                <div class="d-flex flex-column">
                                    <label>Image 1</label>
                                    <input type="file" wire:model="form.image1">
                                    @error('form.image1')
                                ...
                                <div class="d-flex flex-column">
                                    <label>Image 2</label>
                                    <input type="file" wire:model="form.image2">
                                    @error('form.image2')
                                    <span class="alert alert-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="d-flex flex-column">
                                    <label>Image 3</label>
                                    <input type="file" wire:model="form.image3">
                                    @error('form.image3')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-12 mb-2">
                                ...
                                <textarea class="form-control" wire:model="form.complaint"></textarea>
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="text" wire:model="form.actual_latitude" hidden>
                                <input type="text" wire:model="form.actual_longitude" hidden>
